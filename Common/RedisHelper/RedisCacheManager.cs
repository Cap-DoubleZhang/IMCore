...
namespace Common.RedisHelper
{
    public class RedisCacheManager : IRedisCacheManager
    {
        ...
        {
            string redisConfiguration = Consts.RedisIPAddress;//获取连接字符串
            ...
            this.redisPassword = Consts.RedisPassword;
        }
        ...
        private ConnectionMultiplexer GetRedisConnection()
        {
            ...
            lock (redisConnectionLock)
            {
                ...
                try
                {
                    var option = ConfigurationOptions.Parse(redisConnenctionString);
